...
function openMode(m,isReview=false){stop();requestAnimationFrame(sizeScratch);mode=m;review=isReview;$('home').hidden=true;$('play').hidden=false;$('challengeInfo').textContent='';$('modeTitle').textContent=isReview?'틀린 문제 다시 풀기':{add:'덧셈',multiply:'곱셈',divide:'나눗셈',table:'구구단 게임'}[m];let html='';
